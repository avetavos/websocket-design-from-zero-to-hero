...
> 💡 ตัวอย่างจากของจริง
>
> **หลักการเลือกตามทิศทางของข้อมูล (ไม่ระบุชื่อ product เจาะจงสำหรับ SSE เพราะไม่พบแหล่งอ้างอิงปฐมภูมิยืนยันกลไกภายใน):**
> - live event stream ที่เป็น server → client อย่างเดียว มักเลือก SSE — ไม่ต้องการ bidirectional
>
> **Google Meet:** ใช้ WebRTC (SRTP/DTLS) สำหรับ audio/video — UDP-based delivery ลด latency
>
> **Discord:** ใช้ WebSocket สำหรับ Gateway — ต้องการ bidirectional (user action ↔ server event) ([Discord Developer Docs — Gateway](https://discord.com/developers/docs/topics/gateway))
