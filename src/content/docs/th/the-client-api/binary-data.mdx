...
> 💡 ตัวอย่างจากของจริง
>
> **หลักการที่ exchange WebSocket API หลายเจ้าใช้ (เช่น Binance, Bybit; ไม่ระบุตัวเลข "compact กว่า JSON กี่เท่า" เพราะไม่พบแหล่งอ้างอิงปฐมภูมิยืนยัน):**
> - บาง endpoint รองรับส่ง market data เป็น binary แทน JSON — ใช้ `binaryType = 'arraybuffer'` + `DataView` เพื่อ parse ด้วย latency ต่ำ
>
> **หลักการทั่วไปของ multiplayer app (แนวเดียวกับที่ Figma ใช้):**
