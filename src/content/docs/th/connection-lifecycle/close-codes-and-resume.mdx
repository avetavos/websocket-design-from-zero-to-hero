...
>
> **Discord Gateway:**
> - close code 4xxx เช่น 4000 (Unknown error), 4007 (Invalid seq), 4009 (Session timed out) — app ใช้ code แยกว่าควร resume หรือ reconnect fresh ([Discord Developer Docs — Gateway](https://discord.com/developers/docs/topics/gateway))
>
> **Slack (Legacy RTM API, deprecated):**
> - เคยส่ง `goodbye` message ก่อน close เพื่อให้ client รู้ว่าเป็น intentional close ไม่ใช่ connection ขาด
