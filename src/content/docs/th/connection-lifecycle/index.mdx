...
Connection ไม่ใช่สิ่งที่คุณมี แต่เป็นสิ่งที่กำลังเกิดขึ้น เคลื่อนผ่าน **connecting, live, dropped, reconnecting, closed** — และหน้าที่ของคุณคือจัดการทุกลูกศร โดยเฉพาะการไถลเงียบ ๆ จาก *live* ไปสู่ *dropped* ที่ไม่มี event ใดประกาศอย่างน่าเชื่อถือ
</Callout>
...
export const quizIndex = [
  ...
  },
  {
    ...
    options: [
      ...
      'reconnect ไปตลอดและไม่มีวัน closed',
    ],
    answer: 1,
  },
];
