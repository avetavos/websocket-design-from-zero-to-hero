...
>
> **Google Meet:**
> - ใช้ Binary frame สำหรับ video/audio data ผ่าน WebRTC (codec เช่น VP8, Opus)
> - ใช้ Text frame (JSON) สำหรับ control message เช่น mute, chat, participant list
>
> **หลักการทั่วไป (แนวเดียวกับที่ multiplayer/design tool หลายเจ้าใช้):**
> - ส่ง cursor position และ selection state เป็น Binary frame แทน JSON — ลด parsing overhead ของ event ที่ยิงถี่มาก (ไม่มีตัวเลขเปอร์เซ็นต์ที่ยืนยันแหล่งอ้างอิงปฐมภูมิได้ จึงไม่ระบุ)
