...
> - TLS terminate ที่ edge — wss:// ถึง Cloudflare แล้วส่งต่อผ่าน internal network ([Cloudflare — WebSockets](https://developers.cloudflare.com/network/websockets/))
> - มี DDoS protection มาให้ในตัว — ดูดซับ connection flood ก่อนถึง origin server
>
> **Discord Gateway:**
> - ใช้ wss:// เสมอ — message ทุกชิ้น encrypt บน wire ([Discord Developer Docs — Gateway](https://discord.com/developers/docs/topics/gateway))
> - rate limit ต่อ connection (ดูรายละเอียดในบท rate limiting) ช่วยจำกัดผลของ abuse
