...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'WebSocket Foundations', collapsed: true, items: [{ autogenerate: { directory: 'websocket-foundations' } }] },
        { label: 'The Client API', collapsed: true, items: [{ autogenerate: { directory: 'the-client-api' } }] },
        { label: 'Message Design', collapsed: true, items: [{ autogenerate: { directory: 'message-design' } }] },
        { label: 'Connection Lifecycle', collapsed: true, items: [{ autogenerate: { directory: 'connection-lifecycle' } }] },
        { label: 'Server Design', collapsed: true, items: [{ autogenerate: { directory: 'server-design' } }] },
        { label: 'Scaling & Pub/Sub', collapsed: true, items: [{ autogenerate: { directory: 'scaling-and-pubsub' } }] },
        { label: 'Security', collapsed: true, items: [{ autogenerate: { directory: 'security' } }] },
        { label: 'Patterns & Alternatives', collapsed: true, items: [{ autogenerate: { directory: 'patterns-and-alternatives' } }] },
      ],
      }), preact()],
});